...
export function ModeToggle() {
  ...
  useEffect(() => {
    ...
    layout.classList.toggle("_dark_wrapper", dark);
  ...
  return (
    <div className="_layout_mode_swithing_btn">
      ...
      >
        <div
          className="_layout_swithing_btn"
          style={{
            left: dark ? "calc(36px + 0px)" : "calc(10px + 0px)",
          }}
        >
          <div className="_layout_swithing_btn_round" />
        </div>
        <div className="_layout_change_btn_ic1" style={{ opacity: dark ? 0 : 1 }}>
        ...
        <div className="_layout_change_btn_ic2" style={{ visibility: dark ? "visible" : "hidden", opacity: dark ? 1 : 0 }}>
      ...
      <style jsx>{`
        :global(._layout_main_wrapper._dark_wrapper) {
          filter: invert(1) hue-rotate(180deg);
        }
        :global(._layout_main_wrapper._dark_wrapper img) {
          filter: invert(1) hue-rotate(180deg);
        }
      `}</style>
    </div>
